    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="form-group">
                    <input id="añop" name="añop" type="text" class="form-control"
                        placeholder="Ingrese Año de Publicacion">
                ...
                <div class="form-group">
                    <input id="ediccion" name="ediccion" type="text" class="form-control"
                        placeholder="Ingrese Ediccion">
