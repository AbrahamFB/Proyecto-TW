              ...
              <div class="modal-body">
                ...
                <form class="form-horizontal" id="formCliente">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-5">
                        <input id="tipo" name="tipo" type="email" class="form-control" placeholder="Familiar o Individual">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="tdc" class="control-label col-xs-5">Targeta de Bancaria:</label>
                    <div class="col-xs-5">
                        <input id="tdc" name="tdc" type="email" class="form-control" placeholder="4919************">
                    </div>
                  </div>
                  <div class="form-group">
        ...
        function registrar(){
            ...
            if (password===password2) {
                ...
                $.ajax({
                    url:'Controllers/usuario.php',
                    type:'POST',
                    data:'&tipo='+tipo+'&tdc='+tdc+'&email='+email+'&password='+password+'&boton=registrar'
